...
const schools = [
  {
    name: "University of Minnesota—Twin Citie",
    state: "MN",
    ranking: 54,
    tuition: 17214,
    city: " Minneapolis",
  ...
  schools.sort((a, b) => a.ranking - b.ranking);
      ...
      window.onload = function() {
        ...
        if (matchedSchools.length === 0) {
          infoBox.innerHTML = `<p style="text-align:center;">No schools found matching all your requirements.</p>`;
          return;
        }
